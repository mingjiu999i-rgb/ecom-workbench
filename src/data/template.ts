...
export const initialData: WorkbenchData = {
  ...
  skus: [
    { id: 'sku-a', productLinkId: 'link-a', productCostId: 'cost-a', name: '标准装', skuId: 'SKU-A01', specification: '1 件', salePrice: 49.9, finalPrice: 49.9, productCost: 23, shippingCost: 0, packagingCost: 0, otherCost: 0, currentRoi: 5.2, breakEvenRoi: 4.6, activity: '平台活动', activityPrice: 39.9, remark: '' },
    { id: 'sku-b', productLinkId: 'link-b', productCostId: 'cost-b', name: '组合装', skuId: 'SKU-B01', specification: '2 件', salePrice: 89, finalPrice: 89, productCost: 45.5, shippingCost: 0, packagingCost: 0, otherCost: 0, currentRoi: 3.8, breakEvenRoi: 4.3, activity: '无活动', activityPrice: 0, remark: '关注投产' },
  ],
  productCosts: [
